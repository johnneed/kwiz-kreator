...
class PrefsDialog(QtWidgets.QDialog):
    ...
    def setupUi(self):
        ...
        self.mon_checkbox.setChecked(1 in self._preferences.publish_days)
        ...
        self.tue_checkbox.setChecked(2 in self._preferences.publish_days)
        ...
        self.wed_checkbox.setChecked(3 in self._preferences.publish_days)
        ...
        self.thu_checkbox.setChecked(4 in self._preferences.publish_days)
        ...
        self.fri_checkbox.setChecked(5 in self._preferences.publish_days)
        ...
        self.sat_checkbox.setChecked(6 in self._preferences.publish_days)
        ...
        self.sun_checkbox.setChecked(0 in self._preferences.publish_days)
    ...
    def connectControls(self):
        self.mon_checkbox.stateChanged.connect(self._toggle_day(1))
        self.tue_checkbox.stateChanged.connect(self._toggle_day(2))
        self.wed_checkbox.stateChanged.connect(self._toggle_day(3))
        self.thu_checkbox.stateChanged.connect(self._toggle_day(4))
        self.fri_checkbox.stateChanged.connect(self._toggle_day(5))
        self.sat_checkbox.stateChanged.connect(self._toggle_day(6))
        self.sun_checkbox.stateChanged.connect(self._toggle_day(0))
